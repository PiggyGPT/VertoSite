...
const FounderBanner = () => (
  <div className="rounded-xl p-6 md:p-8 mt-8 bg-blue-500/10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 lg:items-center">
          <div className="lg:col-span-1">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mt-2 mb-4">Institutional Liquidity</h3>
