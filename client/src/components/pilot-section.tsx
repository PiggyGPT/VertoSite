...
export default function PilotSection() {
  ...
  return (
    <>
      <section id="pilot" className="py-20 bg-gradient-to-br from-verto-purple/10 via-purple-50/40 to-violet-50/30 dark:from-gray-800/50 dark:via-blue-900/20 dark:to-indigo-900/10 animate-slide-up">
