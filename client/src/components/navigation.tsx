...
export default function Navigation({ onScheduleCall }: NavigationProps) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-md border-b border-white/20 dark:border-white/5`}
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0" data-testid="logo">
              <img src="/logos/svg/albor.svg" alt="Albor Logo" className="h-6 w-auto drop-shadow-md hover:drop-shadow-lg transition-all duration-300" />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-white text-slate-900 rounded-lg font-semibold hover:scale-105 transition-all duration-300 text-xs"
              style={{
