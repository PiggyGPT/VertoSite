      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 md:pt-36 lg:pt-40 pb-12 sm:pb-16 md:pb-20 flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-7 md:mb-8">
            Connect your assets to the $350B dollar stablecoin market
            <br />
        ...
        <div className="w-full max-w-5xl pt-10 sm:pt-12 md:pt-14 lg:pt-16">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 sm:gap-x-10 md:gap-x-12 gap-y-4 sm:gap-y-6 md:gap-y-7 pb-10 sm:pb-12 md:pb-14 lg:pb-16 border-b border-slate-200 dark:border-white/5 opacity-100 grayscale">
        ...
        <div className="w-full max-w-xl mx-auto mt-6 sm:mt-8 md:mt-10 lg:mt-12 mb-12 sm:mb-16 md:mb-20 lg:mb-24 hidden">
          {/* Main Card Display */}
