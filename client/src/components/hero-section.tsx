...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full flex flex-col overflow-hidden text-slate-900 dark:text-white">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-14 md:pt-20 lg:pt-24 pb-6 sm:pb-8 md:pb-12 flex flex-col items-center">
        {/* HEADER */}
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tighter mb-4 sm:mb-6 md:mb-6 text-slate-900 dark:text-white leading-tight">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed mb-4 sm:mb-6 md:mb-8 lg:mb-10">
        ...
        <div className="w-full max-w-5xl pt-4 sm:pt-6 md:pt-5 lg:pt-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 sm:gap-x-10 md:gap-x-12 gap-y-3 sm:gap-y-4 md:gap-y-5 pb-4 sm:pb-6 md:pb-8 lg:pb-10 opacity-100 grayscale">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-3 mt-3 sm:mt-4 md:mt-6 lg:mt-8">
            <button
              onClick={openModal}
