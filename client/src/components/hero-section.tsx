  ...
  return (
    <section id="hero" className="relative bg-white dark:bg-gray-900 pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-12 md:pb-16 px-4 sm:px-6 md:px-8 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <p className="mt-6 sm:mt-8 text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed px-2" data-testid="hero-subtitle">
          {subtitle}
        </p>
