        ...
        <div className="mt-4 sm:mt-6 md:mt-8 max-w-6xl mx-auto">
          ...
          <div className="mt-5 sm:mt-6 md:mt-8 pt-4 sm:pt-5 border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10">
              <img src="/logos/Seal_of_the_United_States_Federal_Reserve_System.svg" alt="Federal Reserve" className="h-8 sm:h-9 md:h-10 opacity-70 hover:opacity-100 transition-opacity dark:brightness-200 dark:invert" />
              <img src="/logos/gsr-markets-logo-vector-2023.svg" alt="GSR Markets" className="h-8 sm:h-9 md:h-10 opacity-70 hover:opacity-100 transition-opacity dark:brightness-200 dark:invert" />
              <img src="/logos/Microsoft_logo_(2012).svg" alt="Microsoft" className="h-8 sm:h-9 md:h-10 opacity-70 hover:opacity-100 transition-opacity dark:brightness-200 dark:invert" />
              <img src="/logos/PayPal_logo.svg" alt="PayPal" className="h-8 sm:h-9 md:h-10 opacity-70 hover:opacity-100 transition-opacity dark:brightness-200 dark:invert" />
            </div>
          </div>
