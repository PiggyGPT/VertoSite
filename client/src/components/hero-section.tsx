    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center overflow-hidden bg-white dark:bg-[#0A0A0B] text-slate-900 dark:text-white">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 md:pt-36 lg:pt-40 pb-12 sm:pb-16 md:pb-20 flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl pt-10 sm:pt-12 md:pt-14 lg:pt-16">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-x-4 sm:gap-x-8 md:gap-x-10 lg:gap-x-12 gap-y-4 sm:gap-y-6 md:gap-y-7 pb-10 sm:pb-12 md:pb-14 lg:pb-16 border-b border-slate-200 dark:border-white/5 opacity-40 hover:opacity-100 transition-opacity duration-500 grayscale">
