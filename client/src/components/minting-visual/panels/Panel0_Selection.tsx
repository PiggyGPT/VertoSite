...
export const Panel0_Selection: React.FC<MintingPanelProps> = ({ isActive, animationState, setAnimationState, onNext }) => {
    return (
        <div className="w-full h-full flex flex-col bg-white dark:bg-slate-900 overflow-hidden relative">
            {/* Header - BANCO REPÚBLICA PANAMÁ */}
            <PanelHeader 
            ...
            <div className="flex-grow p-4 space-y-4 flex flex-col justify-center relative z-0">
               ...
               <div className="relative">
                    ...
                    <div 
                        ...
                        onClick={() => !animationState.isSubmitting && setAnimationState(s => ({ ...s, dropdownOpen: !s.dropdownOpen }))}
                    >
                ...
                {animationState.dropdownOpen && (
                    <>
                        ...
                        <motion.div 
                            ...
                            onClick={() => setAnimationState(s => ({ ...s, dropdownOpen: false }))}
                        />
                        {/* Bottom Sheet */}
                        <motion.div 
                            initial={{ y: '100%' }}
                        ...
                        >
                            ...
                            <div className="p-2 space-y-1">
                                {/* Option: SWIFT */}
                                <div 
                                    onClick={() => setAnimationState(s => ({ ...s, selectedOption: 'fiat', dropdownOpen: false }))}
                                ...
                                <div 
                                    onClick={() => setAnimationState(s => ({ ...s, selectedOption: 'albor', dropdownOpen: false }))}
                                    className={`p-3 rounded-xl flex items-center justify-between cursor-pointer transition-colors ${
