...
export default function AiSection() {
  ...
  return (
    <section id="ai" className="py-20 bg-gradient-to-br from-blue-50/60 via-indigo-50/50 to-violet-50/40 dark:from-gray-800/60 dark:via-blue-900/20 dark:to-indigo-900/10">
