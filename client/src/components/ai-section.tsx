...
export default function AiSection() {
  ...
  return (
    <section id="ai" className="py-20 bg-gradient-to-br from-verto-blue/10 via-blue-50/40 to-indigo-50/30 dark:from-gray-800/60 dark:via-blue-900/20 dark:to-indigo-900/10">
