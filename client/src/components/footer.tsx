...
export default function Footer() {
    ...
    return (
        <footer id="contact" className="text-white" style={{ backgroundColor: 'var(--albor-foundation)' }}>
                ...
                <div className="grid md:grid-cols-12 gap-6 sm:gap-8">
                    ...
                    <div className="md:col-span-4">
                        ...
                        <p className="mt-4 text-slate-400 leading-relaxed text-sm max-w-xs">
                            Stablecoin rails making bank deposits interoperable and instantly tradable with Digital Dollars
