...
export default function TeamSection() {
  const teamMembers = [
    { name: "David Cass", role: "CEO", roleColor: "verto-blue", image: davidImage, description: "Former Fed regulator; ex‑CISO for $50B+ crypto desk", testId: "team-david" },
    ...
    { name: "Hisham Anwar", role: "CTO", roleColor: "verto-orange", image: hishamImage, description: "Built Google Classroom to 150M users; MIT engineer", testId: "team-hisham" },
