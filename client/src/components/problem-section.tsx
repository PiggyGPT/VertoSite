      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200" data-testid="quote-ceo">
            <blockquote className="text-slate-700 leading-relaxed italic text-base mb-4">
            ...
            <div className="flex items-center">
              <div className="w-8 h-8 bg-slate-200 rounded-lg flex items-center justify-center mr-3">
                <Bus className="text-slate-600 w-4 h-4" />
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200" data-testid="quote-head-payments">
            ...
            <div className="flex items-center">
              <div className="w-8 h-8 bg-slate-200 rounded-lg flex items-center justify-center mr-3">
                <CreditCard className="text-slate-600 w-4 h-4" />
              </div>
              <div>
