      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-6xl mx-auto leading-relaxed" data-testid="infrastructure-subtitle">
            Verto orchestrates the complete stablecoin lifecycle with a single, auditable platform — giving you total control over your digital asset operations.
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Trusted Issuance & On-Ramps</h3>
                </div>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  Issue stablecoins against deposits at any bank, kiosk or agent — with KYC/AML policies enforced in real time.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Frictionless Payment Network</h3>
                </div>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Automated Compliance & Reporting</h3>
                </div>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
