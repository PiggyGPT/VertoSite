      ...
      <section id="pilot" className="py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <TimelineItem phase="Days 91-120" title="Controlled Pilot Operations" icon={Target} color="albor-teal">
            ...
            <TimelineItem phase="Days 120+" title="Enterprise Scaling" icon={BarChart3} color="albor-gold">
